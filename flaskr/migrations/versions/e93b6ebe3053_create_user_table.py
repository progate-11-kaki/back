...
def upgrade():
    ...
    sa.Column('user_profile_image', sa.Integer(), nullable=False),
    sa.Column('stars', sa.Integer(), nullable=True),
    sa.Column('star_count', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.ForeignKeyConstraint(['user_name'], ['user.username'], ),
    sa.ForeignKeyConstraint(['user_profile_image'], ['user.profile_image'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('to_user_name', sa.Integer(), nullable=False),
    sa.Column('from_user_id', sa.Integer(), nullable=False),
    sa.Column('from_user_name', sa.Integer(), nullable=False),
    sa.Column('from_user_profile_image', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['from_user_name'], ['user.username'], ),
    sa.ForeignKeyConstraint(['from_user_profile_image'], ['user.profile_image'], ),
    sa.ForeignKeyConstraint(['project_id'], ['project.id'], ),
    sa.ForeignKeyConstraint(['to_user_id'], ['user.id'], ),
    sa.ForeignKeyConstraint(['to_user_name'], ['user.username'], ),
    sa.PrimaryKeyConstraint('id')
    )
